 $(document).ready(function () {
          ...
          for (var i = 0; i < results.length; i++) {
            ...
            $.ajax({
              ...
              for (var j = 0; j < mealResults.length; j++) {
                ...
                var firstEmpty = ingredients.indexOf("");
                var firstSpaceMeas = measurements.indexOf(" ");
                console.log("space index " + firstSpaceMeas);
                console.log("empty index" + firstEmpty);
                newIngredientsArray = ingredients.slice(0, firstSpaceIng);
                if(firstSpaceMeas === -1){
                newMeasurementsArray = measurements.slice(0,firstEmpty);
                }else{
                    newMeasurementsArray = measurements.slice(0, firstSpaceMeas);
                }
                console.log("measurements" + newMeasurementsArray);
      ...
      $(document).on("click", ".drinks", function(){
        ...
        //   console.log("instrustion = " + chosenDrinkInstructions);
        //   console.log("name= " +chosenDrinkName);
        //   console.log("image src = " + chosenDrinkImage);
        //   console.log("recipe= " + chosenDrinkRecipe);
